...
<head>
    <meta charset="UTF-8">
    <title>Parejas Auditivas - Medio | Daily Memory</title>
...
<body>
    ...
    <div class="ecoica-title-row">
        <div class="ecoica-title">Parejas Auditivas (Medio)</div>
        <div class="ecoica-bar">
            <span id="score-label">Score: 0</span>
            <span id="tiempo-label">Tiempo: 50s</span>
        </div>
    </div>
            ...
            <div class="intro-scene">
                ...
                <div id="gov-bubble" class="speech-bubble">
                    ...
                    <div class="intro-content">
                        <p id="gov-msg">
                            Más sonidos, menos tiempo.
                            <br>Tienes <strong>50 segundos</strong>.
                        </p>
