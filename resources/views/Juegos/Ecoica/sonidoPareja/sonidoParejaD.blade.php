...
<head>
    <meta charset="UTF-8">
    <title>Parejas Auditivas - Difícil | Daily Memory</title>
...
<body>
    ...
    <div class="ecoica-title-row">
        <div class="ecoica-title">Parejas Auditivas (Difícil)</div>
            ...
            <div class="intro-scene">
                ...
                <div id="gov-bubble" class="speech-bubble">
                    ...
                    <div class="intro-content">
                        <p id="gov-msg">
                            Reto máximo. Muchos sonidos similares.
                            <br>Tienes <strong>40 segundos</strong>.
                        </p>
