...
<head>
    <meta charset="UTF-8">
    <title>Repetir Palabra - Fácil | Memoria Ecoica</title>
...
<body>
    ...
    <div class="game-top-bar">
        <div class="game-title">Repetir Palabra (Fácil)</div>
        <div class="stats-bar">
            ...
            <div class="intro-scene">
                ...
                <div id="gov-bubble" class="speech-bubble">
                    ...
                    <div class="intro-content">
                        <p id="gov-msg">
                            Nivel Fácil: Escucha palabras simples y repite la secuencia.<br>
                            Meta: <strong>8 rondas</strong>.
                        </p>
