...
<head>
  ...
  <title>Memoria Ecoica — Simon Difícil</title>
  <meta name="csrf-token" content="{{ csrf_token() }}">

  <link rel="stylesheet" href="{{ asset('CSS/Juegos/Ecoica/Simon/simonD.css') }}">
...
<body>
        ...
        <div class="intro-scene">
            ...
            <div id="gov-bubble" class="speech-bubble">
                <div class="intro-header">
                    ...
                    <h2 id="gov-title" class="intro-title">Simon Difícil</h2>
                </div>
                <div class="intro-content">
                    <p id="gov-msg">
                        6 colores. Máxima dificultad.<br>
                        Meta: <strong>20 rondas</strong>.
                    </p>
  ...
  <script src="{{ asset('JS/Juegos/Ecoica/Simon/simonD.js') }}"></script>
</body>
</html>