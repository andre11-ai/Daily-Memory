...
<head>
    <meta charset="UTF-8">
    <title>Scary Witch Typing - Fácil | Daily Memory</title>
...
<body>
    ...
    <main>
        <div class="game-top-bar">
            <div class="game-info">
                <h2>Scary Witch Typing (Fácil)</h2>
                <p>Palabras largas - Enemigos medianos</p>
            </div>
            ...
            <div class="intro-scene">
                ...
                <div id="gov-bubble" class="speech-bubble">
                    <div class="intro-header">
                        ...
                        <h2 id="gov-title" class="intro-title">¡A escribir!</h2>
                    </div>
                    <div class="intro-content">
                        <p id="gov-msg">
                            Escribe las palabras para destruir a los enemigos antes de que te toquen.
                            <br><strong>Dificultad: Fácil</strong>
                        </p>
