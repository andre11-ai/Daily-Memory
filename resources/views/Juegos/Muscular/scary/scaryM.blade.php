...
<head>
    <meta charset="UTF-8">
    <title>Scary Witch Typing - Medio | Daily Memory</title>
...
<body>
    ...
    <main>
        <div class="game-top-bar">
            <div class="game-info">
                <h2>Scary Witch Typing (Medio)</h2>
                <p>Palabras medianas - Enemigos rápidos</p>
            </div>
            ...
            <div class="intro-scene">
                ...
                <div id="gov-bubble" class="speech-bubble">
                    ...
                    <div class="intro-content">
                        <p id="gov-msg">
                            Protege tu base escribiendo las palabras rápidamente.
                            <br><strong>¡Cuidado con la velocidad!</strong>
                        </p>
    ...
    <script src="{{ asset('JS/Juegos/Muscular/scary/appM.js') }}"></script>
</body>
</html>