...
<body>
    ...
    <main class="main-memorama">
        ...
        <section class="section2">
            ...
            <div class="estadisticas" id="t-restante">Tiempo: 120 s</div>
        ...
        <div class="intro-scene">
            ...
            <div id="gov-bubble" class="speech-bubble">
                ...
                <div class="intro-content">
                    <p id="gov-msg">
                        Encuentra todos los pares antes de que se acabe el tiempo. <br>
                        Tiempo límite: <strong>120 segundos</strong>.
                    </p>
