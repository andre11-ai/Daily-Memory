...
<body>
    ...
    <!-- Contenedor principal, tablero a la izquierda y estadísticas a la derecha -->
    <main class="main-memorama">
        <!-- Tablero y título de juego -->
        <section class="section-memorama" id="game-container" data-time="90">
    ...
    <!-- JS -->
    <script src="{{ asset('/JS/Juegos/Iconica/Memorama/memoramaM.js') }}"></script>
</body>
</html>
