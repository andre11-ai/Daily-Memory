...
<body>
    ...
    <main class="main-memorama">
        ...
        <section class="section2">
            ...
            <div class="estadisticas" id="t-restante">Tiempo: 60 s</div>
        ...
        <div class="intro-scene">
            ...
            <div id="gov-bubble" class="speech-bubble">
                <div class="intro-header">
                    <div id="gov-eyebrow" class="intro-eyebrow">NIVEL DIFÍCIL</div>
                    <h2 id="gov-title" class="intro-title">Memorama</h2>
                </div>
                <div class="intro-content">
                    <p id="gov-msg">
                        Desafío máximo. <br>
                        Encuentra todos los pares en <strong>60 segundos</strong>.
                    </p>
    ...
    <script src="/JS/Juegos/Iconica/Memorama/memoramaD.js"></script>
</body>
</html>
