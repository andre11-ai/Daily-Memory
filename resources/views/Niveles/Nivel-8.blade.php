...
<head>
    ...
    <title>Historia Nivel 8 | Daily Memory</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <link rel="stylesheet" href="{{ asset('/CSS/Niveles/Nivel-8.css') }}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap" />
    <link rel="stylesheet" href="https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css">

    <script src="{{ asset('/JS/Niveles/Nivel-8.js') }}" defer></script>
</head>
<body>
    <header class="site-header">
        <nav class="navbar">
            <h1 class="logo">Historia-Nivel 8</h1>
            <div class="nav__list">
        ...
        <div class="intro-scene">
            ...
            <div id="gov-bubble" class="speech-bubble">
                <div class="intro-header">
                    <div id="gov-eyebrow" class="intro-eyebrow">HISTORIA · NIVEL 8</div>
                    <h2 id="gov-title" class="intro-title">Lluvia de Letras</h2>
                </div>
                <div class="intro-content">
                    <p id="gov-msg">
                        Meta: destruye <strong>15 palabras</strong>. <br>
                        Presiona la tecla inicial de cada palabra.
                    </p>
