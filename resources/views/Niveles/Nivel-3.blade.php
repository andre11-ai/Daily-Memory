...
<head>
  ...
  <title>Historia Nivel 3 | Daily Memory</title>
  <meta name="csrf-token" content="{{ csrf_token() }}">

  <link rel="stylesheet" href="{{ asset('/CSS/Niveles/Nivel-3.css') }}">
...
<body>
  <header class="site-header">
    <nav class="navbar">
      <h1 class="logo">Historia-Nivel 3</h1>
      <div class="nav__list">
  ...
  <div class="ecoica-title-row">
    <div class="ecoica-title">Simon</div>
    ...
    <div class="intro-scene">
        ...
        <div id="gov-bubble" class="speech-bubble">
            <div class="intro-header">
                <div id="gov-eyebrow" class="intro-eyebrow">HISTORIA · NIVEL 3</div>
                <h2 id="gov-title" class="intro-title">Simón (Fácil)</h2>
            </div>
            <div class="intro-content">
                <p id="gov-msg">
                    Meta: logra <strong>14 rondas</strong>. <br>
  ...
  <script src="/JS/Niveles/Nivel-3.js"></script>
</body>
</html>