...
<head>
    <meta charset="UTF-8">
    <title>Historia Nivel 10 | Daily Memory</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <link href="{{ asset('/CSS/Niveles/Nivel-10.css') }}" rel="stylesheet">
...
<body>
    <header class="site-header">
        <nav class="navbar">
            <h1 class="logo">Historia-Nivel 10</h1>
            <div class="nav__list">
    ...
    <script src="/JS/Niveles/Nivel-10.js"></script>
</body>
</html>
