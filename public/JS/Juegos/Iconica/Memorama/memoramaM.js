...
function showIntro() {
    ...
    govMsg.innerHTML = "El tiempo corre más rápido.<br>Encuentra los pares en <strong>90 segundos</strong>.";
...
function mostrarModal(gano) {
    ...
    if (gano) {
        ...
        govEyebrow.textContent = "¡BIEN HECHO!";
        govTitle.textContent = "¡Nivel Completado!";
        govMsg.innerHTML = `Completaste el reto en ${tiempoInicial - timer} segundos. <br>¡Sigue así!`;
        ...
        govMsg.innerHTML = "Necesitas ser más veloz. <br>¡No te rindas!";
