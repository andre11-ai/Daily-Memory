document.addEventListener('DOMContentLoaded', function() {
    ...
    let rondaActual = 1, score = 0, vidas = 3, rondaColores = 5;
    ...
    function mostrarModal(gano) {
        ...
        if (gano) {
            ...
            govTitle.textContent = "¡Nivel Medio Superado!";
            govMsg.innerHTML = "Has completado el reto. <br>¡Estás listo para el nivel difícil!";
            ...
            govMsg.innerHTML = "Has perdido todas tus vidas. <br>¡No te rindas!";
    ...
    function reiniciarJuego() {
        rondaActual=1; score=0; vidas=3; rondaColores=5;
        showIntro();
    }
