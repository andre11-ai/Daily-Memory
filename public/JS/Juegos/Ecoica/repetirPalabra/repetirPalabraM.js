document.addEventListener('DOMContentLoaded', function() {
    const TARGET_ROUND = 15; 
    let sonidos = [
        {nombre: 'Campana'}, {nombre: 'Tambor'}, {nombre: 'Rana'}, {nombre: 'Zapato'}
    ];
    ...
    function siguienteRonda() {
        ...
        secuencia = [];
        eleccionUsuario = [];
        feedback.innerText = 'Escucha atentamente...';
        ...
        let interval = setInterval(() => {
            ...
            if (i >= secuencia.length) {
                ...
                feedback.innerText = "¡Repite la secuencia!";
                mostrarBotones();
            }
        }, 1300);
    }
    ...
    function verificarRespuesta() {
        ...
        if (correcto) {
            ...
            feedback.innerText = "Te equivocaste.";
    ...
    function showIntro() {
        ...
        govMsg.innerHTML = `Secuencias más largas.<br>Meta: <strong>${TARGET_ROUND} rondas</strong>.`;
    ...
    function showGameOver(win) {
        ...
        if (win) {
            ...
            govMsg.innerHTML = "Excelente capacidad de retención.";
            actionBtn.textContent = "Jugar de nuevo";
            guardarScore(score);
        } else {
            govBubble.className = "speech-bubble lose-theme";
            govEyebrow.textContent = "ERROR";
            govTitle.textContent = "Juego Terminado";
            govMsg.innerHTML = "Perdiste el hilo de la secuencia.";
    ...
    function guardarScore(score) {
        ...
        fetch('/repetir-palabra-game/score', {
            ...
            body: JSON.stringify({ score: score, difficulty: "medium" })
