document.addEventListener('DOMContentLoaded', function() {
    ...
    let sonidos = [
        {nombre: 'Palma'}, {nombre: 'Golpe'}, {nombre: 'Chasquido'}, {nombre: 'Viento'}, {nombre: 'Lluvia'}
    ];
    ...
    function showIntro() {
        ...
        govMsg.innerHTML = `Sonidos complejos.<br>Meta: <strong>${TARGET_ROUND} rondas</strong>.`;
    ...
    function showGameOver(win) {
        ...
        if (win) {
            ...
            govEyebrow.textContent = "¡ASOMBROSO!";
            govTitle.textContent = "¡Nivel Dominado!";
            govMsg.innerHTML = "Has superado el reto más difícil.";
            ...
            govMsg.innerHTML = "La secuencia fue demasiado larga esta vez.";
