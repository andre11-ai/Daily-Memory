...
class Juego {
    ...
    iniciar() {
        ...
        this.generador = window.setInterval(this.generarPalabra.bind(this), 800);
        this.animador = window.setInterval(() => this.vista.moverPalabra(this, this.modelo), 60);
    ...
    guardarScore(score) {
        fetch('/lluvia-letras-game/score', {
            ...
            body: JSON.stringify({
                score: score,
                difficulty: 'medium', // Atención aquí, para dificultad media
            })
        })
        .then(res => res.json())
...
class Modelo {
    constructor() {
        this.palabras = [
            "Hola", "gato", "pala", "lona", "comida", "comer", "papas", "recreo", "teclado", "escribir",
